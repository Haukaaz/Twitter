  ...
  return (
    <>
      ...
      <div className="flex justify-between gap-2 p-4 items-center border-b-2 border-gray-300">
        ...
        <div>
          <button onClick={() => createPost.mutate()} className="bg-blue-400 text-center py-2 px-4 text-white rounded-full hover:bg-blue-500 transition duration-300">Tweet</button>
        </div>
      </div>
