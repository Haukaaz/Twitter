        ...
        <div className="flex justify-between p-6 border-b-2 border-gray-300">
          ...
          <div className="flex flex-col gap-4">
            ...
            {user.data.email === session?.user?.email ? (
              <button className="bg-blue-400 p-1 text-white rounded-full hover:bg-blue-500 transition duration-300">Edit Profile</button>
            ) : (
              <button onClick={() => followUser.mutate()} className="bg-blue-400 p-1 text-white rounded-full hover:bg-blue-500 transition duration-300">
