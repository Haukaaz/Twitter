    ...
    <div className="flex flex-col gap-2 border-b-2 border-gray-300">
      <div className="flex gap-2 p-4">
        ...
        <div className="flex flex-col">
          <Link href={"/app/profile/" + post.userId} className="font-semibold text-lg hover:underline decoration-2 underline-offset-4">{post.user.name}</Link>
      ...
      <div className="flex justify-between text-center items-center mt-4">
        ...
        <button 
          ...
          className={post.requesterHasLiked ? "text-blue-400 font-semibold w-full p-2 border-x-2 border-t-2 border-gray-300" : "w-full p-2 border-x-2 border-t-2 border-gray-300"}
          >
